    ...
    <div class="row" style="height:auto;">
            <div class="main-page col-12 col-md-12 col-lg-12"style="height:auto;">
                <div class="thong-tin col-10 col-md-10 col-lg-8 mx-auto mb-5" style=" height:auto">
                    ...
                    <h2 style="width: 100% ;color:#BE2031"><b>English:</b>{{$dictionary->dictionary_name_eng}}</h2>
                  
                    <p style="width: 100%" ><b>Vietnamese: </b> {{$dictionary->dictionary_name_vn}}</p>
                   
                    <img src="{{ URL::to('public/uploads/dictionary/'.$dictionary->dictionary_image) }}" style="width: 40%;" alt="">
                ...
                @endforeach
                    ...
                    {{-- <h2>Từ Liên quan.</h2>
                        ...
                        <div class=" col-12 col-md-12 col-lg-12 mx-auto d-flex flex-wrap align-content-center" >
                            @foreach($relate as $key => $lienquan)
                            <a href="{{URL::to('/chi-tiet-tu-dien/'.$lienquan->dictionary_id)}}">
                            <div class="col-sm-4" >
                            <p>{{ $lienquan->dictionary_name_eng }}</p>
                           
                            <img src="{{ URL::to('/public/uploads/dictionary/'.$lienquan->dictionary_image) }}" alt="" style="width:100px;height:100px"/>
                            </a>
                        </div>
                        @endforeach  
                        </div> --}}

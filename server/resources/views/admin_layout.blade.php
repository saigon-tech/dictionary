                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/add-alphabet-dictionary') }}">Thêm danh mục Bảng Chữ Cái</a></li>
                                <li><a href="{{ URL::to('/all-alphabet-dictionary') }}">Liệt kê danh mục Bảng Chữ Cái</a></li>
                        ...
                        <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="{{ URL::to('/all-wordtype-dictionary') }}">Liệt kê danh mục Loại từ </a></li>

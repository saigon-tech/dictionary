                    ...
                    <div class="panel-body">
                       @foreach($edit_alphabet_dictionary as $key => $edit_value)
                        <div class="position-center">
                            <form role="form" action="{{ URL::to('/update-alphabet-dictionary/'.$edit_value->alphabet_id) }}" method="post">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên Bảng Chữ Cái</label>
                                    <input type="text" value="{{ $edit_value->alphabet_name }}" name="alphabet_dictionary_name" class="form-control" id="exampleInputEmail1" placeholder="Tên danh mục">
                                </div>
                                <div class="form-group">
                                    ...
                                    id="exampleInputPassword1" placeholder="Mô tả danh mục">{{$edit_value->alphabet_desc}}</textarea>
                                </div>

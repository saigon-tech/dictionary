				...
				<div class="row">
					<div class="col-sm-7">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="404.html">Giỏi hàng</a></li>
					...
					<div class="col-sm-5">
						...
						<div class="search_box pull-right">
							...
							value="Tìm kiếm" placeholder="Search"/>
						</div>
					</form>
					</div>
				</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{ ('public/frontend/images/girl3.jpg') }}images/home/girl3.jpg" class="girl img-responsive" alt="" />
									<img src="{{ ('public/frontend/images/pricing.png') }}" class="pricing" alt="" />
								</div>
							</div>
